# 592-Cam for PiCamera2

![592-Cam for PiCamera2](https://github.com/monkeymademe/592-Cam/blob/main/static/img/592-Camlogosideways.png)

## Overview

592-Cam for picamera2 is a lightweight web interface for the Raspberry Pi camera module, built on the picamera2 Python library and using Flask. This project provides a user interface to configure camera settings, capture photos, and manage images in a basic gallery.
...
- **Multi Camera Support!:** If you are on a Raspberry Pi5 you can connect 2 cameras at the same time 592-Cam supports using both at the same time
...
- **App Name:** Its now 592-Cam for picamera2
- **More effecant code:** Now v2 of 592-Cam will load faster and deal with camera issues better and can be maintained more easilly if more settings are added to picamera2
...
```bash
[Unit]
Description=592-Cam Server
After=network.target
[Service]
Type=simple
ExecStart=/usr/bin/python /home/pi/592-Cam/app.py
Restart=always
[Install]
